...
if (isset($_POST['register'])) {
    ...
    try {
        ...
        if (strpos($category_id, 'r_') !== false) {
            $auth_admin->registerRecoSupplier($file_name, $first_name, $last_name, $email, $phone, $address, $rank, $category_id, $location, $price, $video, $reco, $desc, $fb_link, $slogan);
        } else {
            $auth_admin->registerSupplier($file_name, $first_name, $last_name, $email, $phone, $address, $rank, $category_id, $location, $price, $video, $reco, $desc, $fb_link, $slogan);
        }
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="text" name="rank" placeholder="דירוג" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row"></div>
                                        <div class="col-md-4">
                                            <input type="number" name="price" placeholder="מחיר" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="text" name="video_link" placeholder="לינק לוידאו"
                                                       class="form-control"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"> סלוגן</label>
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="text" name="slogan" placeholder="סלוגן"
                                                       class="form-control"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" value="1" name="reco" id="inlineCheckbox1"> a
                                        </label>
                                        <label class="checkbox-inline">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <input type="text" name="desc" placeholder="תקציר" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <input type="text" name="fb_link" placeholder="לינק לעמוד פייסבוק"
                                                           class="form-control"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            <button class="btn btn-primary" type="submit" name="register">הוסף ספק
                                            </button>
                                        </div>
                                    </div>
                            </form>
